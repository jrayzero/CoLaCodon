...
struct IdExpr : public Expr {
  ...
  explicit IdExpr(string value, bool isUsage, bool isDef, bool isReduction);
  explicit IdExpr(string value, bool isUsage, bool isDef, bool isReduction, ExprPtr expr);
